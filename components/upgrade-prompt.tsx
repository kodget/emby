...
const lockedFeatures: Record<string, { locked: string[]; unlocked: string[] }> =
  {
    ...
    textbook: {
      locked: [
        "AI-powered textbook recommendations",
        "Relevant chapter suggestions per slide",
        "Medical textbook references (Moore's, Gray's, etc.)",
      ],
      unlocked: ["Class materials access"],
    },
    videos: {
      locked: [
        "AI-curated educational videos per slide",
        "YouTube search links for every topic",
        "Practical demonstration & dissection videos",
      ],
      unlocked: ["Class materials access"],
    },
    "auto-quiz": {
      locked: [
        "20 auto-generated MCQs per slide",
        "Immediate answer feedback & explanations",
        "Track your score across all questions",
      ],
      unlocked: ["Class materials access"],
    },
  };
